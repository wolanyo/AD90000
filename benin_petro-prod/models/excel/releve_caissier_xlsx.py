...
class releve_caissier_xlsx(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(0, 1, "")
        sheet.write(0, 2, "")
        sheet.write(0, 3, "Releve des operations par caissier", bold)
        sheet.write(0, 4, "")
        sheet.write(0, 5, "")
        ...
        sheet.write(4, 0, "Caissier : ", bold)
        sheet.write(4, 1, liste["form"]["caissier"], bold)
        sheet.write(4, 2, "")
        sheet.write(4, 3, "")
    ...
    def get_date(self, obj):
        ...
        total = {}
        if obj.caissier.id:
            liste_conso = obj.env["benin_petro.historique"].search([("sous_chargeur","=",obj.caissier.id)])
        ...
        datas = {
                'form':
                {
                    ...
                    'print_date':d1,
                    'caissier':obj.caissier.access.name,
...
releve_caissier_xlsx('report.releve_caissier.xlsx',
