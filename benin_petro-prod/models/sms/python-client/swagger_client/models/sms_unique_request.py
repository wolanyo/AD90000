...
class SmsUniqueRequest(object):
    ...
    def __init__(self, keyid=None, gmt_zone=None, date_envoi=None, sms=None, num=None, emetteur=None, tracker=None, smslong=None, nostop=None, num_azur=None, ucs2=None):  # noqa: E501
